...
class Test(testing.ServerTest):
    ...
    def start(self):
        ...
        logging.msg('starting server for apache_bug_25520_training\n')
    ...
    def stop(self):
        ...
        logging.msg('stopping server for apache_bug_25520_training\n')
    ...
    def issue(self):
        ...
        logging.msg('issuing requests for apache_bug_25520_training\n')
