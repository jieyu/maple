...
// File: idiom/chess_profiler.hpp - Define the controller for idiom
// CHESS profiler.

#ifndef IDIOM_CHESS_PROFILER_HPP_
#define IDIOM_CHESS_PROFILER_HPP_
...
class ChessProfiler : public systematic::Controller {
 public:
  ChessProfiler();
  ~ChessProfiler() {}
 ...
 private:
  ...
  DISALLOW_COPY_CONSTRUCTORS(ChessProfiler);
};
