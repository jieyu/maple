...
// File: idiom/chess_profiler_main.cpp - The main entrance of the
// idiom profiler using CHESS scheduler.

#include "idiom/chess_profiler.hpp"

#include <csignal>

static idiom::ChessProfiler *prof_ctrl = new idiom::ChessProfiler;
