...
------------------------------------
1     IDIOM_1
	e0: WRITE   [54    target     0x600    atomic_inst.cc +27]
	e1: READ    [54    target     0x600    atomic_inst.cc +27]
2     IDIOM_1
	e0: WRITE   [54    target     0x600    atomic_inst.cc +27]
	e1: READ    [56    target     0x686    atomic_inst.cc +40]
3     IDIOM_1
	e0: WRITE   [32    target     0x61f    atomic_inst.cc +33]
	e1: READ    [54    target     0x600    atomic_inst.cc +27]
"""
