...
------------------------------------
1     IDIOM_1
	e0: WRITE   [62    target     0x794    hb_filter.cc +34]
	e1: WRITE   [72    target     0x76c    hb_filter.cc +42]
2     IDIOM_1
	e0: WRITE   [55    target     0x7bc    hb_filter.cc +26]
	e1: WRITE   [62    target     0x794    hb_filter.cc +34]

(We should not predict 29->45)
"""
...
def iroot_is_expected(r):
    if r.idiom() == 1:
        ...
        if (e0.is_mem_write() and
            ...
            e1.is_mem_write() and
            e1.inst().debug_info() == source_name() + ' +42'):
            return True
        if (e0.is_mem_write() and
